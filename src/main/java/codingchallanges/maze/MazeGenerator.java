...
public class MazeGenerator {
    ...
    private static int MAZE_SIZE = 15;
    private static Random random = new Random();
    private static int[][] maze;

    /**
     * Generates a maze. If level is not given, default size is 7.
     * 
     * @param level level of the maze
     * 
     * @return the generated maze
     */
    public static Maze generateMaze(MazeLevel level) {
        MAZE_SIZE = level != null ? level.getSize() : 15;
    ...
    /**
     * The main entry point of the MazeGenerator service.
     * Used to generate a simple maze and show it on the console.
     * 
     * @param args arguments
     */
    public static void main(String[] args) {
        Maze maze = generateMaze(MazeLevel.ADVANCED);
